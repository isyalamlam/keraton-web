...
<template>
  ...
  <div class="title">
    ...
    <div class="content-1">
      <div class="txt2">
        <img src="../assets/images/Frame (1).png" class="img-user">
    ...
    <div class="content-3">
      <div class="txt4">
        <img src="../assets/images/Frame (5).png" class="img-det-tiket">
    ...
    <div class="tmbh-brg">
      <div class="input-tiket1">
        ...
        <p class="input-tiket2">1</p>
        <button class="tambah">+</button></div>
    </div>
    </div>
    <div class="content-5">
...
<div id="ringkasanBooking">
          ...
          <div class="totalTagihan">
              ...
              <h6 class="ringkasan">Rp.13.500</h6>
          </div>
          ...
          <div class="btn-checkout">
            ...
            <p><img src="./assets/image/Frame.svg" alt=""></p>
          </div>
        </button>
        </div>
      </div>
